...
$sql = "SELECT * FROM complaints WHERE approved LIKE 'Pending'";
...
<body>
        ...
        <div class="container aaa">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav" id="mainNav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle customersServiceSection active" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Customer Services
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col">
                <h1 class="d-inline" id="headerTreasurer">Complaint(s)</h1>
            </div>
        </div>
        <div id="tableBody">
            <table class="table table-hover mt-4 mb-5">
                <thead class="">
                    <tr>
                        <th id="boderBot" scope="col">Name</th>
                        <th id="boderBot" scope="col">Complaint</th>
                        <th id="boderBot" scope="col">Contact Number</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="" method="post">
                                    <a class="btn btn-success" href="Approved-complaints.php?id=<?php echo $row['id']; ?>" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-lg" viewBox="0 0 16 16">
                                            <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z" />
                                        </svg></a>
                                    <a class="btn btn-danger" href="Reject-complaint.php?id=<?php echo $row['id']; ?>" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
