...
$news2 = $con->query($sql) or die($con->error);
$row2 = $news2->fetch_assoc();
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE news_events SET news_description = '$news' WHERE id = '$id'";
...
<body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-6 headerAcInfo">
                    <h1>ADMINISTRATOR</h1>
                    <h6>Welcome Back <?php echo $fName; ?></h6>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container mt-5">
        ...
        <form action="" method="post">
            <div class="row">
                <div class="col">
                    <h1 class="d-inline" id="headerTreasurer">Edit Form</h1>
                </div>
                <div class="col text-center">
                    <button type="submit" id="addBtn" name="submit" value="Update Form" class="btn btn-primary">Edit News</button>
                    <a class="btn btn-danger" id="cancelBtn" href="News-events.php" role="button">Cancel</a>
                </div>
            </div>
            <textarea class="mt-5" name="news" id="complaint" cols="138" rows="5" placeholder="Enter description..."> <?php echo $row2['news_description'] ?> </textarea>
        </form>
