...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `news_events`(`name`, `news_description`) VALUES ('$name', '$news')";
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="" method="post">
            <div class="row">
                <div class="col">
                    <h1 class="d-inline" id="headerTreasurer">News Form</h1>
                </div>
                <div class="col text-center">
                    <button type="submit" id="addBtn" name="submit" value="Update Form" class="btn btn-primary">Add News</button>
                    <a class="btn btn-danger" id="cancelBtn" href="News-events.php" role="button">Cancel</a>
                </div>
            </div>
            <textarea class="mt-5" name="news" id="complaint" cols="138" rows="5" placeholder="Enter description..."></textarea>
        </form>
