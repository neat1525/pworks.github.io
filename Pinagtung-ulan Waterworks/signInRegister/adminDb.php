...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <h1 class="d-inline" id="headerTreasurer">Secretary</h1>
            </div>
            <div class="col text-center">
                <a class="btn btn-success" id="btnAdd" target="" href="Admin-add-employee.php" role="button">Add New Employee</a>
            </div>
            <div class="col mt-4">
                <iframe src="tblSecretary.php"" class=" cashierFrame" name="cashierFrame" height="300px" width="1210px"></iframe>
            </div>

            <div class="container mt-2">
                <h1 id="headerTreasurer">Treasurer</h1>
                <div class="mt-4">
                    <iframe src="tblTreasurer.php"" class=" cashierFrame" name="cashierFrame" height="300px" width="1210px"></iframe>
                </div>
            </div>

            <div class="container mt-2 mb-5">
                <h1 id="headerTreasurer">Cashier</h1>
                <div class="mt-4">
                    <iframe src="tblCashier.php"" class=" cashierFrame" name="cashierFrame" height="300px" width="1210px"></iframe>
                </div>
            </div>
        </div>
    </div>
