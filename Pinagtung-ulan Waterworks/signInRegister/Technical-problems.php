...
$sql = "SELECT * FROM complaints WHERE approved LIKE 'Approved'";
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col">
                <h1 class="d-inline" id="headerTreasurer">Approved Complaint(s)</h1>
            </div>
        </div>
        <div id="tableBody">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="" method="post">
                                    <a class="btn btn-danger" href="Archived-complaint.php?id=<?php echo $row['id']; ?>" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-archive-fill" viewBox="0 0 16 16">
