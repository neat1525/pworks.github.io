...
if (isset($_POST['submit'])) {
    ...
    $amount = $_POST['amount'];
    $postedBy =  $_SESSION['namesss'];

    $sql = "INSERT INTO `expenses`(`type`, `remarks`, `amount`, `postedBy`) VALUES ('$expensesType', '$remarks', '$amount', '$postedBy')";
    $con->query($sql) or die($con->error);

    echo header("Location: Expenses.php");
}
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="" method="post">
            ...
            <input name="remarks" type="text" id="remarks" placeholder="Remarks">

            <label for="amount">Amount</label>
            <input name="amount" type="number" id="amount" placeholder="amount" min="0" max="100000">

            <br>
            <button type="submit" name="submit" value="Submit Form" class="btn btn-primary">Confirm Expenses</button>
            <a class="btn btn-warning" href="Expenses.php" role="button">Cancel</a>
