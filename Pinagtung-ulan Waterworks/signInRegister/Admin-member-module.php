...
<body>
        ...
        <div class="container aaa">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav" id="mainNav">
                    ...
                    <li>
                        <a class="nav-link active memberSection" href="Admin-member-module.php" id="navbarDropdownMenuLink">Members</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <h1 class="d-inline" id="headerTreasurer">Members</h1>
            </div>
            <div class="col text-center">
                <a class="btn btn-success" id="btnAdd" target="member" href="Admin-add-member.php?id=<?php echo $row['id']; ?>" role="button">Add New Member</a>
            </div>
            <div class="mt-4">
                <iframe src="Admin-member-tbl.php"" class=" member" name="member" height="650px" width="1210px" style="margin-bottom: 200px;"></iframe>
            </div>
        </div>
    </div>
