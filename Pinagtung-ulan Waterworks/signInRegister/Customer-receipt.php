...
<body>
        ...
        <div class="container aaa">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav" id="mainNav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active receiptSection" href="Customer-receipt.php">Receipt</a>
                    </li>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <h1 class="d-inline" id="headerTreasurer">Receipt</h1>
            </div>
            <div id="tableBody">
                <table class="table table-hover mb-5">
                    <thead class="">
                        <tr>
                            ...
                            <th id="boderBot" scope="col">Payment Method</th>
                            <th id="boderBot" scope="col">Collected By</th>
